...
export declare const yandexMapSettings: Ref<YandexMapPluginSettings>;
/**
     ...
     */
export declare const isYandexMapReadyToInit: import('vue').ComputedRef<boolean>;
export declare const yandexMapYmaps3: () => typeof import("@yandex/ymaps3-types");
export declare const yandexMapScript: import('vue').ShallowRef<HTMLElement | null, HTMLElement | null>;
export declare class YandexMapException extends Error {
    constructor(message: string);
}
export type YandexMapLoadStatus = 'pending' | 'loading' | 'loaded' | 'error';
export declare const yandexMapLoadStatus: Ref<YandexMapLoadStatus, YandexMapLoadStatus>;
export declare const yandexMapIsLoaded: import('vue').ComputedRef<boolean>;
export declare const yandexMapLoadError: Ref<string | Error | {
...
/**
     ...
     * @internal
     */
export declare function importLayersExtra(): Promise<YandexMapLayersExtra>;
